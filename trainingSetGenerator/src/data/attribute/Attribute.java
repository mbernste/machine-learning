...
public class Attribute 
{
	...
	/**
	 * If this attribute is a nominal attribute, this method will return the name
	 * of a nominal value for this attribute given the nominal value ID of that value
	 * 
	...
	public String getNominalValueName(Integer attrValueId)
	{
		...
		{
			System.err.println("Error retrieving nominal value name for the ID " + attrValueId +
					". Trying to retrieve a nominal value from a continuous attribute, " + 
					this.name + ".");
		...
		{
			System.err.println("Error retrieving nominal value name for the ID " + attrValueId +
					".  This value ID is not a possible value for the attribute " + this.name + ".");
			return nominalValueName;
		}
	...
	/**
	 * If this attribute is a nominal attribute, this method will return an integer
	 * corresponding to the ID of this attribute's possible value.
	 * 
	...
	public Integer getNominalValueId(String attrValueName)
	{
		...
		if (this.type == Attribute.CONTINUOUS)
		{
			System.err.println("Error retrieving nominal value Id for the value " + attrValueName +
					". Trying to retrieve a nominal value from a continuous attribute, " + 
					this.name + ".");
			return valueId;
		}
		...
		{
			System.err.println("Error retrieving nominal value Id for the value " + attrValueName +
					".  This value name is not a possible value for the attribute " + this.name + ".");
			return valueId;
		}
		
		return nominalValueMap.get(attrValueName);
	}
}
